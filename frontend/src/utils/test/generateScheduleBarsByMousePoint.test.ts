...
describe('Test #1 - 좌표 대응 테스트', () => {
  it('상대 좌표가 우측에 있을 경우, 그에 대응되는 날짜가 이동된 스케줄 바가 반환되어야 한다.', () => {
  ...
  it('상대 좌표가 좌상단에 있을 경우, 그에 대응되는 날짜가 이동된 스케줄 바가 반환되어야 한다. 또한, 범위 바깥의 스케줄 바는 잘려야 한다.', () => {
    const schedule: Schedule = {
      id: 1,
      title: '내 일정',
      startDateTime: '2023-11-14 00:00',
  ...
  it('상대 좌표가 우하단에 있을 경우, 그에 대응되는 날짜가 이동된 스케줄 바가 반환되어야 한다. 또한, 이동된 일정에 따라 적절하게 스케줄 바의 모양이 바뀌어야 한다.', () => {
    const schedule: Schedule = {
      id: 1,
      title: '빡구현좋아',
  ...
  it('상대 좌표의 이동거리가 짧아 일정에 변화가 없는 경우, 변화되지 않은 스케줄 바 그대로를 반환해야 한다.', () => {
    const schedule: Schedule = {
      id: 1,
      title: '내 일정',
      startDateTime: '2023-11-14 00:00',
...
describe('Test #2 - 캘린더 크기 대응 테스트', () => {
  it('캘린더의 크기가 평소와 달라진 경우, 상대 좌표도 다르게 계산하여 반영하여야 한다.', () => {
    const schedule: Schedule = {
      id: 1,
      title: '내 일정',
      startDateTime: '2023-11-14 00:00',
...
describe('Test #3 - 부가 기능 테스트', () => {
  it('캘린더 바의 사이즈, 레벨을 별도로 지정한 후 해당 설정으로 반영된 스케줄 바가 반환되어야 한다.', () => {
    const schedule: Schedule = {
      id: 1,
      title: '내 일정',
      startDateTime: '2023-11-14 00:00',
