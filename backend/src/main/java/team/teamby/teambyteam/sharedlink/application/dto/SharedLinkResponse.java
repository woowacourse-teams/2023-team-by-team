...
public record SharedLinkResponse(
    ...
    public static SharedLinkResponse of(final SharedLink sharedLink, final String memberName) {
        ...
        return new SharedLinkResponse(sharedLink.getId(), sharedLink.getTitle().getValue(), sharedLink.getSharedURL().getValue(), sharedLink.getMemberId(), memberName, updatedAt);
    }
}
