...
`,ButtonContainer=styled_components_browser_esm.I4.div`
  ...
  column-gap: 10px;
  margin-left: auto;
`,exitButton=styled_components_browser_esm.AH`
  display: flex;
  align-items: center;
  ...
  gap: 2px;
  margin: 0 auto;
`,strongContent=styled_components_browser_esm.AH`
...
`,cancelButton=styled_components_browser_esm.AH`
  width: 80px;

  background-color: ${({theme})=>theme.color.GRAY500};
`,exitConfirmButton=styled_components_browser_esm.AH`
  width: 80px;

  background-color: ${({theme})=>theme.color.RED};
`,teamNameInput=styled_components_browser_esm.AH`
  padding: 0 10px;
...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const TeamExitModal=props=>{const{onClose}=props,{openModal}=(0,useModal.h)(),{teamName,displayName,handlers:{handleTeamNameChange,handleSubmit,handleClose}}=useTeamExitModal(onClose);return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsxs)(Button.A,{type:"button",variant:"normal",onClick:openModal,css:exitButton,children:["팀 나가기",(0,jsx_runtime.jsx)(svg.LogoutIcon,{})]}),(0,jsx_runtime.jsxs)(Modal.A,{children:[(0,jsx_runtime.jsx)(Backdrop,{onClick:handleClose}),(0,jsx_runtime.jsx)("form",{onSubmit:handleSubmit,children:(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsx)(Header,{children:(0,jsx_runtime.jsx)(Button.A,{type:"button",variant:"plain",onClick:handleClose,css:closeButton,children:(0,jsx_runtime.jsx)(svg.CloseIcon,{})})}),(0,jsx_runtime.jsxs)(Body,{children:[(0,jsx_runtime.jsxs)("label",{children:[(0,jsx_runtime.jsxs)(Text.A,{as:"span",size:"lg",children:["팀 탈퇴를 위해"," ",(0,jsx_runtime.jsx)(Text.A,{as:"strong",size:"lg",weight:"semiBold",css:strongContent,children:displayName}),"을(를) 입력해 주세요."]}),(0,jsx_runtime.jsx)(Input.A,{width:"340px",height:"40px",placeholder:displayName,css:teamNameInput,autoFocus:!0,required:!0,value:teamName,onChange:handleTeamNameChange})]}),(0,jsx_runtime.jsxs)(ButtonContainer,{children:[(0,jsx_runtime.jsx)(Button.A,{type:"button",css:cancelButton,onClick:handleClose,children:"취소"}),(0,jsx_runtime.jsx)(Button.A,{disabled:teamName!==displayName,css:exitConfirmButton,children:"확인"})]})]})]})})]})]})},TeamExitModal_TeamExitModal=TeamExitModal;try{TeamExitModal.displayName="TeamExitModal",TeamExitModal.__docgenInfo={description:"",displayName:"TeamExitModal",props:{onClose:{defaultValue:null,description:"",name:"onClose",required:!0,type:{name:"() => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/team/TeamExitModal/TeamExitModal.tsx#TeamExitModal"]={docgenInfo:TeamExitModal.__docgenInfo,name:"TeamExitModal",path:"src/components/team/TeamExitModal/TeamExitModal.tsx#TeamExitModal"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/team/TeamPlaceInfoModal/TeamPlaceInfoModal.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>TeamPlaceInfoModal_TeamPlaceInfoModal});var react=__webpack_require__("./node_modules/react/index.js"),Modal=__webpack_require__("./src/components/common/Modal/Modal.tsx"),Text=__webpack_require__("./src/components/common/Text/Text.tsx"),TeamExitModal=__webpack_require__("./src/components/team/TeamExitModal/TeamExitModal.tsx"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),TeamBadge=__webpack_require__("./src/components/team/TeamBadge/TeamBadge.tsx"),Input=__webpack_require__("./src/components/common/Input/Input.tsx"),ModalContext=__webpack_require__("./src/components/common/Modal/ModalContext.tsx"),useModal=__webpack_require__("./src/hooks/useModal.ts"),user=__webpack_require__("./src/constants/user.ts"),useQuery=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/useQuery.mjs"),team=__webpack_require__("./src/apis/team.ts"),query=__webpack_require__("./src/constants/query.ts");var QueryClientProvider=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/QueryClientProvider.mjs"),useMutation=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/useMutation.mjs");var useClickOutside=__webpack_require__("./src/hooks/useClickOutside.ts"),useTeamPlace=__webpack_require__("./src/hooks/useTeamPlace.ts"),useToast=__webpack_require__("./src/hooks/useToast.ts");const getMe=members=>members.find((member=>member.isMe)),getMeFirstMembers=members=>{const me=getMe(members),others=members.filter((member=>!1===member.isMe));return me?[me,...others]:others},useTeamPlaceInfoModal=()=>{const{teamPlaceId,teamPlaceColor,displayName}=(0,useTeamPlace.Y)(),{showToast}=(0,useToast.d)(),{members}=(teamPlaceId=>{const{data}=(0,useQuery.I)(["teamPlaceMembers",teamPlaceId],(()=>(0,team.ec)(teamPlaceId)),{enabled:teamPlaceId>0,staleTime:query.S.TEAM_PLACE_MEMBERS}),{members}=data??{};return{members}})(teamPlaceId),{inviteCode}=(teamPlaceId=>{const{data}=(0,useQuery.I)(["teamPlaceInviteCode",teamPlaceId],(()=>(0,team.HT)(teamPlaceId)),{enabled:teamPlaceId>0,staleTime:query.S.TEAM_PLACE_INVITE_CODE}),{teamPlaceId:id,inviteCode}=data??{};return{id,inviteCode}})(teamPlaceId),{mutateModifyMyTeamPlaceUserInfo}=(teamPlaceId=>{const queryClient=(0,QueryClientProvider.jE)(),{mutate}=(0,useMutation.n)((body=>(0,team.on)(teamPlaceId,body)),{onSuccess:()=>{queryClient.invalidateQueries(["teamPlaceMembers"])}});return{mutateModifyMyTeamPlaceUserInfo:mutate}})(teamPlaceId),[isEditing,setIsEditing]=(0,react.useState)(!1),[myUserName,setMyUserName]=(0,react.useState)(""),myUserInfoRef=(0,react.useRef)(null);(0,useClickOutside.L)(myUserInfoRef,(()=>{setIsEditing((()=>!1))}));return(0,react.useEffect)((()=>{const me=getMe(members??[]);me&&setMyUserName((()=>me.name))}),[members,isEditing]),{teamPlaceId,teamPlaceColor,displayName,members:getMeFirstMembers(members??[]),inviteCode,isEditing,myUserName,myUserInfoRef,handlers:{handleCopyButtonClick:()=>{if(inviteCode)try{navigator.clipboard.writeText(inviteCode),showToast("success","초대 코드가 복사되었습니다.")}catch(error){showToast("error","초대 코드 복사에 실패했습니다.")}},handleMyUserInfoSubmit:e=>{e.preventDefault();const name=myUserName.trim(),previousName=getMe(members??[])?.name;""!==name&&name!==previousName?name.length>user.O?showToast("error",`닉네임은 최대 ${user.O}자까지 입력할 수 있습니다.`):mutateModifyMyTeamPlaceUserInfo({name:myUserName},{onSuccess:()=>{setIsEditing((()=>!1)),showToast("success","닉네임이 변경되었습니다.")},onError:()=>{showToast("error","닉네임 변경에 실패했습니다.")}}):setIsEditing((()=>!1))},handleMyUserNameChange:e=>{e.target.value.length<=user.O&&setMyUserName((()=>e.target.value))},handleUserInfoEditButtonClick:()=>{setIsEditing((()=>!0))}}}};var svg=__webpack_require__("./src/assets/svg/index.ts"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Backdrop=styled_components_browser_esm.I4.div`
  position: fixed;
  top: 0;
  left: 0;
...
`,Container=styled_components_browser_esm.I4.div`
  ...
  overflow: hidden;
`,TeamPlaceName=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;

  gap: 8px;
  margin-bottom: 10px;
`,MemberDescription=styled_components_browser_esm.I4.div`
  display: flex;
  justify-content: space-between;
`,MemberList=styled_components_browser_esm.I4.ul`
  display: flex;
  flex-direction: column;
...
`,MemberListItem=styled_components_browser_esm.I4.li`
  display: flex;
  align-items: center;
...
`,ProfileImage=styled_components_browser_esm.I4.img`
  ...
  border-radius: 50%;
  object-fit: cover;
`,InviteCodeContainer=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`,InviteCodeWrapper=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;
...
`,MyUserInfo=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;

  width: 100%;
  column-gap: 10px;
`,Badge=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  color: ${({theme})=>theme.color.WHITE};
`,MyUserInfoForm=styled_components_browser_esm.I4.form`
  display: flex;
  align-items: center;
...
`,userName=styled_components_browser_esm.AH`
  max-width: 120px;
  ...
  text-overflow: ellipsis;
  text-align: center;
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const TeamPlaceInfoModal_TeamPlaceInfoModal=()=>{const{closeModal}=(0,useModal.h)(),{teamPlaceColor,displayName,members,inviteCode,isEditing,myUserName,myUserInfoRef,handlers:{handleCopyButtonClick,handleMyUserInfoSubmit,handleMyUserNameChange,handleUserInfoEditButtonClick}}=useTeamPlaceInfoModal();return(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:(0,jsx_runtime.jsxs)(Modal.A,{children:[(0,jsx_runtime.jsx)(Backdrop,{onClick:closeModal}),(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsxs)(TeamPlaceName,{children:[(0,jsx_runtime.jsx)(TeamBadge.A,{teamPlaceColor,size:"md"}),(0,jsx_runtime.jsx)(Text.A,{as:"span",size:"lg",weight:"semiBold",css:teamName,children:displayName})]}),(0,jsx_runtime.jsx)(Divider,{}),(0,jsx_runtime.jsxs)(MemberDescription,{children:[(0,jsx_runtime.jsx)(Text.A,{as:"span",weight:"semiBold",children:"팀원 목록"}),(0,jsx_runtime.jsxs)(Text.A,{as:"span",children:["총 ",members.length,"명"]})]}),(0,jsx_runtime.jsx)(MemberList,{children:members.map((member=>{const{id,name,profileImageUrl,isMe}=member;return isMe?(0,jsx_runtime.jsx)(react.Fragment,{children:(0,jsx_runtime.jsxs)(MemberListItem,{children:[(0,jsx_runtime.jsx)(ProfileImage,{src:profileImageUrl,alt:name}),isEditing?(0,jsx_runtime.jsx)(MyUserInfoForm,{onSubmit:handleMyUserInfoSubmit,children:(0,jsx_runtime.jsxs)(MyUserInfo,{ref:myUserInfoRef,children:[(0,jsx_runtime.jsxs)(UserNameInputContainer,{children:[(0,jsx_runtime.jsx)(Input.A,{width:"120px",height:"100%",placeholder:name,value:myUserName,onChange:handleMyUserNameChange,minLength:1,maxLength:user.O,css:userNameInput,autoFocus:!0}),(0,jsx_runtime.jsx)(Text.A,{as:"span",css:userNameLength,children:`${myUserName.length}/${user.O}`})]}),(0,jsx_runtime.jsx)(Button.A,{variant:"plain",css:userInfoSubmitButton,children:(0,jsx_runtime.jsx)(svg.CheckBlackIcon,{})})]})}):(0,jsx_runtime.jsxs)(MyUserInfo,{children:[(0,jsx_runtime.jsx)(Text.A,{as:"span",css:userName,children:name}),(0,jsx_runtime.jsx)(Badge,{children:(0,jsx_runtime.jsx)(Text.A,{weight:"semiBold",as:"span",size:"xs",children:"나"})}),(0,jsx_runtime.jsx)(Button.A,{type:"button",variant:"plain","aria-label":"닉네임 수정하기",css:userInfoEditButton,onClick:handleUserInfoEditButtonClick,children:(0,jsx_runtime.jsx)(svg.EditIcon,{})})]})]})},id):(0,jsx_runtime.jsx)(react.Fragment,{children:(0,jsx_runtime.jsxs)(MemberListItem,{children:[(0,jsx_runtime.jsx)(ProfileImage,{src:profileImageUrl,alt:name}),(0,jsx_runtime.jsx)(Text.A,{as:"span",children:name})]})},id)}))}),(0,jsx_runtime.jsx)(Divider,{}),(0,jsx_runtime.jsx)(Text.A,{as:"span",weight:"semiBold",children:"초대 코드"}),(0,jsx_runtime.jsxs)(InviteCodeContainer,{children:[(0,jsx_runtime.jsx)(InviteCodeWrapper,{children:(0,jsx_runtime.jsx)(Text.A,{as:"span",size:"lg",children:inviteCode})}),(0,jsx_runtime.jsx)(Button.A,{type:"button",variant:"plain",css:copyButton,onClick:handleCopyButtonClick,children:(0,jsx_runtime.jsx)(svg.ClipboardIcon,{})})]}),(0,jsx_runtime.jsx)(Divider,{}),(0,jsx_runtime.jsx)(ModalContext.Z,{children:(0,jsx_runtime.jsx)(TeamExitModal.A,{onClose:closeModal})})]})]})})}},"./src/constants/query.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{S:()=>STALE_TIME});const STALE_TIME={SCHEDULES:3e4,DAILY_SCHEDULES:3e4,MY_SCHEDULES:3e4,MY_DAILY_SCHEDULES:3e4,USER_INFO:3e5,TEAM_PLACE_MEMBERS:6e4,TEAM_PLACE_INVITE_CODE:1/0,TEAM_LINKS:6e4,TEAM_FEED:3e5,ICALENDAR_URL:1/0}},"./src/constants/routes.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{K:()=>PATH_NAME});const PATH_NAME={LANDING:"/",POLICY:"/policy",LOGIN:"/login",START:"/start",JOIN:"/join",CREATE:"/create",TEAM_SELECT:"/team",TEAM_OVERVIEW:"/team/overview",TEAM_CALENDAR:"/team/calendar",TEAM_FEED:"/team/feed",TEAM_LINK:"/team/link"}},"./src/constants/user.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{F:()=>ACCOUNT_DELETE_CONFIRM_TEXT,O:()=>MAX_USER_NAME_LENGTH});const MAX_USER_NAME_LENGTH=20,ACCOUNT_DELETE_CONFIRM_TEXT="탈퇴합니다"},"./src/hooks/useClickOutside.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{L:()=>useClickOutside});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js");const useClickOutside=(ref,callback)=>{(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)((()=>{const handleClickOutside=e=>{ref.current&&!ref.current.contains(e.target)&&callback(e)};return document.addEventListener("mousedown",handleClickOutside),document.addEventListener("touchstart",handleClickOutside),()=>{document.removeEventListener("mousedown",handleClickOutside),document.removeEventListener("touchstart",handleClickOutside)}}),[callback,ref])}},"./src/hooks/useModal.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{h:()=>useModal});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_components_common_Modal_ModalContext__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/common/Modal/ModalContext.tsx");const useModal=()=>{const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_components_common_Modal_ModalContext__WEBPACK_IMPORTED_MODULE_1__.V);if(void 0===context)throw new Error("useModal must be used within a ModalProvider");return context}},"./src/hooks/useTeamPlace.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Y:()=>useTeamPlace});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_contexts_TeamPlaceContext__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/contexts/TeamPlaceContext.tsx");const useTeamPlace=()=>{const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_contexts_TeamPlaceContext__WEBPACK_IMPORTED_MODULE_1__.W);if(void 0===context)throw new Error("useTeamPlace must be used within a TeamPlaceContext");return context}},"./src/hooks/useToast.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{d:()=>useToast});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_components_common_Toast_ToastContext__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/common/Toast/ToastContext.tsx");const useToast=()=>{const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_components_common_Toast_ToastContext__WEBPACK_IMPORTED_MODULE_1__.$);if(void 0===context)throw new Error("useToast must be used within a ToastProvider");return context}}}]);
//# sourceMappingURL=9100.e9b5258d.iframe.bundle.js.map