...
`,MenuContainer=styled_components_browser_esm.I4.div`
  ...
  ${({$isMobile})=>$isMobile?styled_components_browser_esm.AH`
      ...
      gap: 30px;
    `}
`,MenuLink=(0,styled_components_browser_esm.I4)(react_router_dom_dist.k2)`
  display: flex;
  align-items: center;
...
`,teamAddButton=styled_components_browser_esm.AH`
  display: flex;
  align-items: center;
  justify-content: center;
  flex-direction: column;
...
`,teamAddText=styled_components_browser_esm.AH`
  font-size: 11px;
`;var Text=__webpack_require__("./src/components/common/Text/Text.tsx"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),getIsMobile=__webpack_require__("./src/utils/getIsMobile.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const NavigationBar=()=>{const navigate=(0,dist.Zp)(),location=(0,dist.zy)(),isMobile=(0,getIsMobile.N)();return(0,jsx_runtime.jsx)(Nav,{$isMobile:isMobile,children:(0,jsx_runtime.jsxs)(MenuContainer,{$isMobile:isMobile,children:[!isMobile&&(0,jsx_runtime.jsxs)(MenuLink,{to:routes.K.TEAM_OVERVIEW,children:[(0,jsx_runtime.jsx)(svg.fA,{}),(0,jsx_runtime.jsx)(Text.A,{as:"span",children:"모아보기"})]}),(0,jsx_runtime.jsxs)(MenuLink,{to:routes.K.TEAM_CALENDAR,children:[(0,jsx_runtime.jsx)(svg.CT,{}),!isMobile&&(0,jsx_runtime.jsx)(Text.A,{as:"span",children:"캘린더"})]}),(0,jsx_runtime.jsxs)(MenuLink,{to:routes.K.TEAM_FEED,children:[(0,jsx_runtime.jsx)(svg.Y1,{}),!isMobile&&(0,jsx_runtime.jsx)(Text.A,{as:"span",children:"채팅"})]}),(0,jsx_runtime.jsxs)(MenuLink,{to:routes.K.TEAM_LINK,children:[(0,jsx_runtime.jsx)(svg.PW,{}),!isMobile&&(0,jsx_runtime.jsx)(Text.A,{as:"span",children:"링크"})]}),(0,jsx_runtime.jsxs)(Button.A,{type:"button",variant:"plain",css:teamAddButton,onClick:()=>{navigate(routes.K.START,{state:{from:location}})},children:[(0,jsx_runtime.jsx)(svg.qJ,{}),!isMobile&&(0,jsx_runtime.jsx)(Text.A,{as:"span",css:teamAddText,children:"팀 참가/개설"})]})]})})};NavigationBar.displayName="NavigationBar";const NavigationBar_stories={title:"common/NavigationBar",component:NavigationBar,tags:["autodocs"]},Default={args:{}},__namedExportsOrder=["Default"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  args: {}\n}",...Default.parameters?.docs?.source}}}}}]);
//# sourceMappingURL=components-common-NavigationBar-NavigationBar-stories.2358f8c0.iframe.bundle.js.map