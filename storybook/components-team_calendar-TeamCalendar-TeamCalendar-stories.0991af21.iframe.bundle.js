...
`,Inner=styled_components_browser_esm.zo.div.withConfig({shouldForwardProp:prop=>!["id","scheduleId","schedule","row","column","duration","level","roundedStart","roundedEnd","teamPlaceColor"].includes(prop)})`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
//# sourceMappingURL=components-team_calendar-TeamCalendar-TeamCalendar-stories.0991af21.iframe.bundle.js.map