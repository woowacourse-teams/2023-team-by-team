"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[9334],{"./src/components/feed/NoticeThread/NoticeThread.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{ContentWithLink:()=>ContentWithLink,Default:()=>Default,ImageContent:()=>ImageContent,MiddleContent:()=>MiddleContent,TooLongContent:()=>TooLongContent,__namedExportsOrder:()=>__namedExportsOrder,default:()=>NoticeThread_stories});var react=__webpack_require__("./node_modules/react/index.js"),Text=__webpack_require__("./src/components/common/Text/Text.tsx"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),ThumbnailList=__webpack_require__("./src/components/feed/ThumbnailList/ThumbnailList.tsx");var parseThreadContent=__webpack_require__("./src/utils/parseThreadContent.ts"),svg=__webpack_require__("./src/assets/svg/index.ts"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),png=__webpack_require__("./src/assets/png/index.ts");const Container=styled_components_browser_esm.I4.div`
  position: sticky;
  ...
  ${({$noticeSize,$hasImage})=>"sm"===$noticeSize?styled_components_browser_esm.AH`
        height: 80px;
      `:"md"===$noticeSize&&$hasImage?styled_components_browser_esm.AH`
        height: 200px;
      `:"md"===$noticeSize?styled_components_browser_esm.AH`
        height: 140px;
      `:"lg"===$noticeSize?styled_components_browser_esm.AH`
        height: 610px;
      `:void 0}
`,BackgroundContainer=styled_components_browser_esm.I4.div`
  display: flex;
  ...
  background-image: url(${png.HP});
  background-size: 100%;

  transition: 0.3s;

  ${({$noticeSize})=>"sm"===$noticeSize||"md"===$noticeSize?styled_components_browser_esm.AH`
...
`,InnerContainer=styled_components_browser_esm.I4.div`
  ...
  gap: 10px;
`,ArrowContainer=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: flex-end;
  justify-content: flex-end;
`,ArrowIcon=styled_components_browser_esm.I4.div`
  width: 32px;
  height: 32px;
...
`,MegaphoneWrapper=styled_components_browser_esm.I4.div`
  position: absolute;
  top: 0;

  width: 40px;
`,AuthorInfo=styled_components_browser_esm.I4.div`
  display: flex;
  flex-wrap: wrap;
  flex-shrink: 0;
  align-items: center;
...
`,ContentContainer=styled_components_browser_esm.I4.div`
  ...
  ${({$noticeSize})=>{if("lg"===$noticeSize)return styled_components_browser_esm.AH`
        height: 400px;
      `}}
`,Divider=styled_components_browser_esm.I4.span`
...
`,LinkContent=styled_components_browser_esm.I4.a`
  color: ${({theme})=>theme.color.PRIMARY900};
...
`,authorInfoText=styled_components_browser_esm.AH`
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;

  color: ${({theme})=>theme.color.GRAY500};
`,timeInfoText=styled_components_browser_esm.AH`
  color: ${({theme})=>theme.color.GRAY500};
`,contentField=(noticeSize,hasImage)=>{let height="";return"sm"===noticeSize&&(height="24px"),"md"===noticeSize&&(height=hasImage?"24px":"66px"),"lg"===noticeSize&&(height="100%"),styled_components_browser_esm.AH`
...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Text=props=>{const{as="p",size,weight,css,children}=props;return(0,jsx_runtime.jsx)(TextWrapper,{as,size,css,weight,children})},Text_Text=Text;try{Text.displayName="Text",Text.__docgenInfo={description:"",displayName:"Text",props:{as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"h1"'},{value:'"h2"'},{value:'"h3"'},{value:'"h4"'},{value:'"h5"'},{value:'"h6"'},{value:'"p"'},{value:'"span"'},{value:'"strong"'}]}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"xxs"'},{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"xl"'},{value:'"xxl"'}]}},weight:{defaultValue:null,description:"",name:"weight",required:!1,type:{name:"enum",value:[{value:'"bold"'},{value:'"normal"'},{value:'"light"'},{value:'"semiBold"'}]}},css:{defaultValue:null,description:"",name:"css",required:!1,type:{name:"CSSProp"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/common/Text/Text.tsx#Text"]={docgenInfo:Text.__docgenInfo,name:"Text",path:"src/components/common/Text/Text.tsx#Text"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/feed/DeletableThumbnail/DeletableThumbnail.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>DeletableThumbnail_DeletableThumbnail});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.li`
  ...
  border-radius: 12px;
`,Image=styled_components_browser_esm.I4.img`
  width: 100%;
  height: 100%;
  ...
  object-fit: cover;
`,deleteButton=styled_components_browser_esm.AH`
  position: absolute;
  top: -4px;
  right: -4px;
...
`,FileUploadInput=styled_components_browser_esm.I4.input`
  display: none;
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const ImageAddButton=props=>{const{onChangeImage}=props;return(0,jsx_runtime.jsxs)("label",{children:[(0,jsx_runtime.jsx)(FakeButton,{role:"button","aria-label":"이미지 추가",children:(0,jsx_runtime.jsx)(svg.PlusIcon,{})}),(0,jsx_runtime.jsx)(FileUploadInput,{type:"file",accept:"image/*",onChange:onChangeImage,multiple:!0})]})},ImageAddButton_ImageAddButton=ImageAddButton;try{ImageAddButton.displayName="ImageAddButton",ImageAddButton.__docgenInfo={description:"",displayName:"ImageAddButton",props:{onChangeImage:{defaultValue:null,description:"",name:"onChangeImage",required:!0,type:{name:"(e: ChangeEvent<HTMLInputElement>) => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/feed/ImageAddButton/ImageAddButton.tsx#ImageAddButton"]={docgenInfo:ImageAddButton.__docgenInfo,name:"ImageAddButton",path:"src/components/feed/ImageAddButton/ImageAddButton.tsx#ImageAddButton"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/feed/ThumbnailList/ThumbnailList.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>ThumbnailList_ThumbnailList});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.ul`
  display: flex;
  flex-direction: row;
  flex-shrink: 0;
  column-gap: 12px;
  ...
  ${({$mode,$size})=>"view"===$mode?"sm"===$size?styled_components_browser_esm.AH`
          overflow-x: auto;
          overflow-y: hidden;
...
`,Image=styled_components_browser_esm.I4.img`
  ...
  object-fit: cover;
`,viewButton=styled_components_browser_esm.AH`
  width: 100%;
  height: 100%;
  padding: 0;

  border-radius: 12px;
`;var Button=__webpack_require__("./src/components/common/Button/Button.tsx"),png=__webpack_require__("./src/assets/png/index.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const ViewableThumbnail=props=>{const{image,size="md",onClick}=props,{isExpired,name,url}=image;return(0,jsx_runtime.jsx)(Container,{$size:size,children:(0,jsx_runtime.jsx)(Button.A,{variant:"plain",type:"button",css:viewButton,onClick,"aria-label":`${name} 이미지 자세히 보기`,children:(0,jsx_runtime.jsx)(Image,{src:isExpired?png.gm:url,alt:name,onError:e=>{e.currentTarget.src=png.gm,e.currentTarget.alt="손상된 이미지"}})})})},ViewableThumbnail_ViewableThumbnail=ViewableThumbnail;try{ViewableThumbnail.displayName="ViewableThumbnail",ViewableThumbnail.__docgenInfo={description:"",displayName:"ViewableThumbnail",props:{image:{defaultValue:null,description:"",name:"image",required:!0,type:{name:"ThreadImage"}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'}]}},onClick:{defaultValue:null,description:"",name:"onClick",required:!0,type:{name:"() => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/feed/ViewableThumbnail/ViewableThumbnail.tsx#ViewableThumbnail"]={docgenInfo:ViewableThumbnail.__docgenInfo,name:"ViewableThumbnail",path:"src/components/feed/ViewableThumbnail/ViewableThumbnail.tsx#ViewableThumbnail"})}catch(__react_docgen_typescript_loader_error){}},"./src/constants/feed.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{GB:()=>DEFAULT_MAX_THREAD_HEIGHT,Lo:()=>THREAD_SIZE,jf:()=>MAX_UPLOAD_IMAGE_COUNT,w0:()=>THREAD_TYPE});const DEFAULT_MAX_THREAD_HEIGHT=500,THREAD_TYPE={THREAD:"thread",NOTIFICATION:"notification"},THREAD_SIZE=20,MAX_UPLOAD_IMAGE_COUNT=4},"./src/constants/link.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{K:()=>linkTableHeaderValues,_:()=>URL_REGEX});const linkTableHeaderValues=["링크명","이름","날짜",""],URL_REGEX=/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([-.]{1}[a-z0-9]+)*\.[a-z]{2,12}(:[0-9]{1,5})?(\/.*)?$/i},"./src/utils/generateHttpsUrl.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{m:()=>generateHttpsUrl});const HTTPS_PREFIX_REGEX=/^https?:\/\/.*/,generateHttpsUrl=url=>HTTPS_PREFIX_REGEX.test(url)?url:`https://${url}`},"./src/utils/getIsMobile.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{N:()=>getIsMobile});const getIsMobile=()=>{const isIos=null!==window.navigator.userAgent.match(/ipad|iphone/i),isAndroid=null!==window.navigator.userAgent.match(/Android/i);return!(!isIos&&!isAndroid)}},"./src/utils/parseThreadContent.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{V:()=>parseThreadContent});var _constants_link__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./src/constants/link.ts"),_utils_generateHttpsUrl__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/utils/generateHttpsUrl.ts");const LINK_SEPARATOR_REGEX=/\S+(?=https?:\/\/)|https?:\/\/\S+|\s+|\S+/g,parseThreadContent=rawContent=>{const splittedThreadContent=rawContent.match(LINK_SEPARATOR_REGEX)??[],generatedThreadContent=[];let textContent="";return splittedThreadContent.forEach((currentContent=>{const isLink=_constants_link__WEBPACK_IMPORTED_MODULE_0__._.test(currentContent);isLink&&""!==textContent&&(generatedThreadContent.push({type:"text",text:textContent}),textContent=""),isLink?generatedThreadContent.push({type:"link",text:currentContent,link:(0,_utils_generateHttpsUrl__WEBPACK_IMPORTED_MODULE_1__.m)(currentContent)}):textContent+=currentContent})),""!==textContent&&generatedThreadContent.push({type:"text",text:textContent}),generatedThreadContent}}}]);
//# sourceMappingURL=components-feed-NoticeThread-NoticeThread-stories.3bca0a30.iframe.bundle.js.map