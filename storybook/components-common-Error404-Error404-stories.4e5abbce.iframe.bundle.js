"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[3957],{"./src/components/common/BackButton/BackButton.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>BackButton_BackButton});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const ArrowLeftIconWrapper=styled_components_browser_esm.I4.div`
  transition: 0.3s;
...
`,backButton=styled_components_browser_esm.AH`
  display: inline-flex;
  align-items: center;
  column-gap: 12px;
  ...
  height: 42px;
  padding: 4px;
`;var dist=__webpack_require__("./node_modules/react-router/dist/index.js"),svg=__webpack_require__("./src/assets/svg/index.ts"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),Text=__webpack_require__("./src/components/common/Text/Text.tsx"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const BackButton=props=>{const{label,href}=props,navigate=(0,dist.Zp)();return(0,jsx_runtime.jsxs)(Button.A,{type:"button",variant:"plain",css:backButton,onClick:()=>{navigate(href||-1)},children:[(0,jsx_runtime.jsx)(ArrowLeftIconWrapper,{children:(0,jsx_runtime.jsx)(svg.Ak,{})}),(0,jsx_runtime.jsx)(Text.A,{weight:"semiBold",children:label})]})};BackButton.displayName="BackButton";const BackButton_BackButton=BackButton;try{BackButton.displayName="BackButton",BackButton.__docgenInfo={description:"",displayName:"BackButton",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},href:{defaultValue:null,description:"",name:"href",required:!1,type:{name:"enum",value:[{value:'"/"'},{value:'"/policy"'},{value:'"/login"'},{value:'"/start"'},{value:'"/join"'},{value:'"/create"'},{value:'"/team"'},{value:'"/team/overview"'},{value:'"/team/calendar"'},{value:'"/team/feed"'},{value:'"/team/link"'}]}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/common/BackButton/BackButton.tsx#BackButton"]={docgenInfo:BackButton.__docgenInfo,name:"BackButton",path:"src/components/common/BackButton/BackButton.tsx#BackButton"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/common/Button/Button.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>Button_Button});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const paddingSize={sm:"6px",md:"12px",lg:"18px"},variants={primary:styled_components_browser_esm.AH`
...
`,ErrorImage=styled_components_browser_esm.I4.img`
  width: 333px;
  height: 307px;
`,ErrorDetails=styled_components_browser_esm.I4.div`
  display: flex;
  ...
  width: 300px;
  height: auto;
`,ErrorTextImage=styled_components_browser_esm.I4.img`
  width: 231px;
  height: 102px;
...
`,errorText=styled_components_browser_esm.AH`
  font-size: 24px;
  white-space: nowrap;
`,error_404_image_namespaceObject=__webpack_require__.p+"static/media/error-404-image.5241edeb.webp",error_404_text_namespaceObject=__webpack_require__.p+"static/media/error-404-text.35d7bdae.webp";var Text=__webpack_require__("./src/components/common/Text/Text.tsx"),BackButton=__webpack_require__("./src/components/common/BackButton/BackButton.tsx"),routes=__webpack_require__("./src/constants/routes.ts"),getIsMobile=__webpack_require__("./src/utils/getIsMobile.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Error404=props=>{const{isLoggedIn}=props,isMobile=(0,getIsMobile.N)(),location=window.location.href;return(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsx)(ErrorImage,{src:error_404_image_namespaceObject,alt:"해당 페이지를 찾을 수 없어요"}),(0,jsx_runtime.jsxs)(ErrorDetails,{children:[isMobile&&location.includes("overview")?(0,jsx_runtime.jsx)(Text.A,{size:"xxl",weight:"bold",css:errorText,children:"모바일에서는 이용할 수 없는 페이지에요!"}):(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsx)(ErrorTextImage,{src:error_404_text_namespaceObject,alt:"404"}),(0,jsx_runtime.jsx)(Text.A,{size:"xxl",weight:"bold",css:errorText,children:"해당 페이지를 찾을 수 없어요!"})]}),(0,jsx_runtime.jsx)(BackButton.A,{href:isLoggedIn?isMobile?routes.K.TEAM_CALENDAR:routes.K.TEAM_OVERVIEW:routes.K.LANDING,label:isLoggedIn?isMobile?"팀 캘린더 페이지로":"모아보기 페이지로":"랜딩 페이지로"})]})]})};Error404.displayName="Error404";const Error404_Error404=Error404;try{Error404.displayName="Error404",Error404.__docgenInfo={description:"",displayName:"Error404",props:{isLoggedIn:{defaultValue:null,description:"",name:"isLoggedIn",required:!0,type:{name:"boolean"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/common/Error404/Error404.tsx#Error404"]={docgenInfo:Error404.__docgenInfo,name:"Error404",path:"src/components/common/Error404/Error404.tsx#Error404"})}catch(__react_docgen_typescript_loader_error){}const Error404_stories={title:"common/Error404",component:Error404_Error404,tags:["autodocs"],argTypes:{isLoggedIn:{description:"사용자의 로그인 여부를 의미합니다. 이 값에 따라 사용자에게 안내해 주는 페이지가 달라집니다."}},parameters:{docs:{description:{component:"`Error404`는 404 에러 페이지에서 사용되는 컴포넌트입니다."}}}},LoggedIn={args:{isLoggedIn:!0}},NotLoggedIn={args:{isLoggedIn:!1}},__namedExportsOrder=["LoggedIn","NotLoggedIn"];LoggedIn.parameters={...LoggedIn.parameters,docs:{...LoggedIn.parameters?.docs,source:{originalSource:"{\n  args: {\n    isLoggedIn: true\n  }\n}",...LoggedIn.parameters?.docs?.source}}},NotLoggedIn.parameters={...NotLoggedIn.parameters,docs:{...NotLoggedIn.parameters?.docs,source:{originalSource:"{\n  args: {\n    isLoggedIn: false\n  }\n}",...NotLoggedIn.parameters?.docs?.source}}}}}]);
//# sourceMappingURL=components-common-Error404-Error404-stories.4e5abbce.iframe.bundle.js.map