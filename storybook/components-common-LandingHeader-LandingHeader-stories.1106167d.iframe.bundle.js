"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[751],{"./src/components/common/LandingHeader/LandingHeader.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>LandingHeader_stories});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.header`
  height: 64px;
  padding: 0 14px;
`,landingPageLinkButton=styled_components_browser_esm.AH`
  display: flex;
  align-items: center;

  padding: 0;
  column-gap: 20px;
`,headerTitle=styled_components_browser_esm.AH`
  font-size: 32px;
  font-weight: 800;
  color: ${({theme})=>theme.color.PRIMARY};
  text-align: right;
`;var Text=__webpack_require__("./src/components/common/Text/Text.tsx"),svg=__webpack_require__("./src/assets/svg/index.ts"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),dist=__webpack_require__("./node_modules/react-router/dist/index.js"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const LandingHeader=props=>{const{href}=props,navigate=(0,dist.Zp)();return(0,jsx_runtime.jsx)(Container,{children:(0,jsx_runtime.jsxs)(Button.A,{type:"button",variant:"plain",css:landingPageLinkButton,onClick:()=>navigate(href),"aria-label":"메인 페이지로 이동",children:[(0,jsx_runtime.jsx)(svg.LogoIcon,{}),(0,jsx_runtime.jsx)(Text.A,{as:"h1",css:headerTitle,children:"팀바팀"})]})})},LandingHeader_LandingHeader=LandingHeader;try{LandingHeader.displayName="LandingHeader",LandingHeader.__docgenInfo={description:"",displayName:"LandingHeader",props:{href:{defaultValue:null,description:"",name:"href",required:!0,type:{name:"string"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/common/LandingHeader/LandingHeader.tsx#LandingHeader"]={docgenInfo:LandingHeader.__docgenInfo,name:"LandingHeader",path:"src/components/common/LandingHeader/LandingHeader.tsx#LandingHeader"})}catch(__react_docgen_typescript_loader_error){}var routes=__webpack_require__("./src/constants/routes.ts");const LandingHeader_stories={title:"common/LandingHeader",component:LandingHeader_LandingHeader,tags:["autodocs"],parameters:{docs:{description:{component:"`LandingHeader` 팀플레이스 페이지가 아닌 페이지에서 사용될 간략화된 헤더 컴포넌트입니다."}}}},Default={args:{href:routes.K.LANDING}},__namedExportsOrder=["Default"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  args: {\n    href: PATH_NAME.LANDING\n  }\n}",...Default.parameters?.docs?.source}}}},"./src/components/common/Button/Button.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>Button_Button});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const paddingSize={sm:"6px",md:"12px",lg:"18px"},variants={primary:styled_components_browser_esm.AH`
...
//# sourceMappingURL=components-common-LandingHeader-LandingHeader-stories.1106167d.iframe.bundle.js.map