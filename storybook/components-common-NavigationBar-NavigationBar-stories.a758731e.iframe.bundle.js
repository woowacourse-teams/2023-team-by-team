...
`,teamAddText=styled_components_browser_esm.iv`
  font-size: 11px;
`;var Text=__webpack_require__("./src/components/common/Text/Text.tsx"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const NavigationBar=()=>{const navigate=(0,dist.s0)(),location=(0,dist.TH)();return(0,jsx_runtime.jsx)(Nav,{children:(0,jsx_runtime.jsxs)(MenuContainer,{children:[(0,jsx_runtime.jsxs)(MenuLink,{to:routes.y.TEAM_OVERVIEW,children:[(0,jsx_runtime.jsx)(svg.tv,{}),(0,jsx_runtime.jsx)(Text.Z,{as:"span",children:"모아보기"})]}),(0,jsx_runtime.jsxs)(MenuLink,{to:routes.y.TEAM_CALENDAR,children:[(0,jsx_runtime.jsx)(svg.Qu,{}),(0,jsx_runtime.jsx)(Text.Z,{as:"span",children:"캘린더"})]}),(0,jsx_runtime.jsxs)(MenuLink,{to:routes.y.TEAM_FEED,children:[(0,jsx_runtime.jsx)(svg.Jw,{}),(0,jsx_runtime.jsx)(Text.Z,{as:"span",children:"피드"})]}),(0,jsx_runtime.jsxs)(MenuLink,{to:routes.y.TEAM_LINK,children:[(0,jsx_runtime.jsx)(svg.fq,{}),(0,jsx_runtime.jsx)(Text.Z,{as:"span",children:"링크"})]}),(0,jsx_runtime.jsxs)(Button.Z,{type:"button",variant:"plain",css:teamAddButton,onClick:()=>{navigate(routes.y.START,{state:{from:location}})},children:[(0,jsx_runtime.jsx)(svg.Vc,{}),(0,jsx_runtime.jsx)(Text.Z,{as:"span",css:teamAddText,children:"팀 참가/개설"})]})]})})};NavigationBar.displayName="NavigationBar";const NavigationBar_stories={title:"common/NavigationBar",component:NavigationBar,tags:["autodocs"]},Default={args:{}};Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  args: {}\n}",...Default.parameters?.docs?.source}}};const __namedExportsOrder=["Default"]},"./src/components/common/Button/Button.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Z:()=>Button_Button});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const paddingSize={sm:"6px",md:"12px",lg:"18px"},variants={primary:styled_components_browser_esm.iv`
...
//# sourceMappingURL=components-common-NavigationBar-NavigationBar-stories.a758731e.iframe.bundle.js.map