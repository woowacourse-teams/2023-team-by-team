...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Text=props=>{const{as="p",size,weight,css,children}=props;return(0,jsx_runtime.jsx)(TextWrapper,{as,size,css,weight,children})};Text.displayName="Text";const Text_Text=Text;try{Text.displayName="Text",Text.__docgenInfo={description:"",displayName:"Text",props:{as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"h1"'},{value:'"h2"'},{value:'"h3"'},{value:'"h4"'},{value:'"h5"'},{value:'"h6"'},{value:'"p"'},{value:'"span"'},{value:'"strong"'}]}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"xxs"'},{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"xl"'},{value:'"xxl"'}]}},weight:{defaultValue:null,description:"",name:"weight",required:!1,type:{name:"enum",value:[{value:'"bold"'},{value:'"normal"'},{value:'"light"'},{value:'"semiBold"'}]}},css:{defaultValue:null,description:"",name:"css",required:!1,type:{name:"CSSProp"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/common/Text/Text.tsx#Text"]={docgenInfo:Text.__docgenInfo,name:"Text",path:"src/components/common/Text/Text.tsx#Text"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/landing/FeedDecoration/FeedDecoration.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>FeedDecoration_FeedDecoration});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.div`
  ...
  height: 100%;
  padding: 50px;
`,SampleBadge=styled_components_browser_esm.I4.div`
  width: 36px;
  height: 36px;

  border-radius: 18px;
  background-color: ${({theme})=>theme.color.BLUE600};
`,SampleThread=styled_components_browser_esm.I4.div`
  display: flex;
  flex-direction: column;
  row-gap: 12px;
  ...
  ${({$css})=>$css};
`,CircleButtonsContainer=styled_components_browser_esm.I4.div`
  display: flex;
  flex-direction: column;
  row-gap: 14px;
  position: absolute;
  top: 476px;
  right: 66px;
`,CircleButton=styled_components_browser_esm.I4.div`
  width: 68px;
  height: 68px;
  padding: 14px;
...
`,WritingLine=styled_components_browser_esm.I4.div`
  width: 0;
  height: 20px;
  border-radius: 10px;
  ...
  animation: ${({$width})=>{return width=$width,styled_components_browser_esm.i7`
  from {
    width: 0;
  }
  to {
...
`,SampleBadge=styled_components_browser_esm.I4.div`
  ...
  border-radius: 18px;
  background-color: ${({theme})=>theme.color.BLUE600};
`,WritingLinesContainer=styled_components_browser_esm.I4.div`
  display: flex;
  flex-direction: column;
  row-gap: 50px;

  padding-top: 30px;
`,blink=styled_components_browser_esm.i7`
  0% {
    opacity: 1;
  }
  12% {
...
`,styled_components_browser_esm.I4.div`
  ...
  animation-delay: ${({$delay})=>$delay};
`);var svg=__webpack_require__("./src/assets/svg/index.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const FileDriveDecoration=()=>(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsx)(SampleBadge,{}),(0,jsx_runtime.jsx)(svg.uG,{}),(0,jsx_runtime.jsxs)(WritingLinesContainer,{children:[(0,jsx_runtime.jsx)(WritingLine,{$width:"46%",$delay:"0s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"60%",$delay:"0.3s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"52%",$delay:"0.6s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"0",$delay:"0"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"60%",$delay:"0.9s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"72%",$delay:"1.2s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"66%",$delay:"1.5s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"38%",$delay:"1.8s"})]})]});FileDriveDecoration.displayName="FileDriveDecoration";const FileDriveDecoration_FileDriveDecoration=FileDriveDecoration},"./src/components/landing/TeamCalendarDecoration/TeamCalendarDecoration.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>TeamCalendarDecoration_TeamCalendarDecoration});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.div`
  display: flex;
  flex-direction: column;
  row-gap: 30px;
...
`,SampleBadge=styled_components_browser_esm.I4.div`
  ...
  border-radius: 18px;
  background-color: ${({theme})=>theme.color.BLUE600};
`,CalendarHeaderContainer=styled_components_browser_esm.I4.div`
  display: flex;
  ...
  width: 100%;
  height: 40px;
`,CalendarContainer=styled_components_browser_esm.I4.div`
  position: relative;

  width: 100%;
  height: 500px;
`,CalendarTable=styled_components_browser_esm.I4.div`
  display: grid;
  ...
  width: 100%;
  height: 100%;
`,SampleCalendarBarContainer=styled_components_browser_esm.I4.div`
  position: absolute;
  top: 0;
  left: 0;
  ...
  width: 100%;
  height: 100%;
`,SampleCalendarBar=styled_components_browser_esm.I4.div`
  position: absolute;
...
`,CalendarCell=styled_components_browser_esm.I4.div`
  background-color: ${({theme})=>theme.color.BLUE200};
`,backAndForth=styled_components_browser_esm.i7`
  0% {
    top: 70%;
    left: 70%;
    opacity: 0;
...
`,MousePointer=styled_components_browser_esm.I4.img`
  position: absolute;
  top: 70%;
  left: 70%;
...
`,cardRotate=afterDegree=>styled_components_browser_esm.i7`
  0% {
...
`,Card=styled_components_browser_esm.I4.div`
  position: absolute;
  right: 60%;
  bottom: -30%;
  ...
  ${({$css})=>$css}
`,invertedFadeInOut=styled_components_browser_esm.i7`
  0% {
    opacity: 1;
  }
  14%,
...
`,Blind=styled_components_browser_esm.I4.div`
  position: absolute;
  top: 0;
  left: 0;
  ...
  ${({$animation=!0})=>$animation&&styled_components_browser_esm.AH`
    ...
    `}
`,card1=animation=>styled_components_browser_esm.AH`
  background-color: ${({theme})=>theme.color.BLUE400};

  ${animation?()=>styled_components_browser_esm.AH`
        transform: rotate(-60deg);
        animation: ${()=>cardRotate("10deg")} 1.5s forwards;
      `:()=>styled_components_browser_esm.AH`
        transform: rotate(10deg);
      `}
`,card2=animation=>styled_components_browser_esm.AH`
  background-color: ${({theme})=>theme.color.BLUE200};
  ...
  ${animation?()=>styled_components_browser_esm.AH`
      ...
      `}
`,card3=animation=>styled_components_browser_esm.AH`
  background-color: ${({theme})=>theme.color.BLUE100};
  ...
  ${animation?()=>styled_components_browser_esm.AH`
      ...
      `}
`;var TeamCalendarDecoration=__webpack_require__("./src/components/landing/TeamCalendarDecoration/TeamCalendarDecoration.tsx"),FeedDecoration=__webpack_require__("./src/components/landing/FeedDecoration/FeedDecoration.tsx"),FileDriveDecoration=__webpack_require__("./src/components/landing/FileDriveDecoration/FileDriveDecoration.tsx"),landing=__webpack_require__("./src/constants/landing.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const IntroCardPile=props=>{const{animation=!0}=props,[decorationNo,setDecorationNo]=(0,react.useState)(0),blindRef=(0,react.useRef)(null);return(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsx)(Card,{$css:card1(animation)}),(0,jsx_runtime.jsx)(Card,{$css:card2(animation)}),(0,jsx_runtime.jsxs)(Card,{$css:card3(animation),children:[0===decorationNo?(0,jsx_runtime.jsx)(TeamCalendarDecoration.A,{animation}):1===decorationNo?(0,jsx_runtime.jsx)(FeedDecoration.A,{}):(0,jsx_runtime.jsx)(FileDriveDecoration.A,{}),(0,jsx_runtime.jsx)(Blind,{ref:blindRef,$animation:animation,onAnimationIteration:()=>{setDecorationNo((prev=>(prev+1)%landing.z))}})]})]})};IntroCardPile.displayName="IntroCardPile";const IntroCardPile_IntroCardPile=IntroCardPile;try{IntroCardPile.displayName="IntroCardPile",IntroCardPile.__docgenInfo={description:"",displayName:"IntroCardPile",props:{animation:{defaultValue:null,description:"",name:"animation",required:!1,type:{name:"boolean"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/landing/IntroCardPile/IntroCardPile.tsx#IntroCardPile"]={docgenInfo:IntroCardPile.__docgenInfo,name:"IntroCardPile",path:"src/components/landing/IntroCardPile/IntroCardPile.tsx#IntroCardPile"})}catch(__react_docgen_typescript_loader_error){}const IntroCardPile_stories={title:"landing/IntroCardPile",component:IntroCardPile_IntroCardPile,tags:["autodocs"],parameters:{docs:{description:{component:"`IntroCardPile` 컴포넌트는 랜딩 페이지의 부속품에 해당하는 컴포넌트로,\n여러 장의 카드를 이용하여 팀바팀 서비스의 간략화된 UI를 미리 보여줍니다.\n랜딩 페이지의 왼쪽에 배치하여 메인 디자인 요소로 사용될 것입니다."}}}},Default={args:{}},NoAnimation={args:{animation:!1}},__namedExportsOrder=["Default","NoAnimation"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  args: {}\n}",...Default.parameters?.docs?.source}}},NoAnimation.parameters={...NoAnimation.parameters,docs:{...NoAnimation.parameters?.docs,source:{originalSource:"{\n  args: {\n    animation: false\n  }\n}",...NoAnimation.parameters?.docs?.source},description:{story:"이 옵션은 랜딩 페이지와 동일한 배경을 보여주어야 하지만 애니메이션을 이용하여 사용자의 시선을 끌기에는 적합하지 않은 페이지에 적합합니다.\n\n예를 들면, 팀 초대 링크를 입력하는 페이지가 있습니다.",...NoAnimation.parameters?.docs?.description}}};try{NoAnimation.displayName="NoAnimation",NoAnimation.__docgenInfo={description:"이 옵션은 랜딩 페이지와 동일한 배경을 보여주어야 하지만 애니메이션을 이용하여 사용자의 시선을 끌기에는 적합하지 않은 페이지에 적합합니다.\n\n예를 들면, 팀 초대 링크를 입력하는 페이지가 있습니다.",displayName:"NoAnimation",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/landing/IntroCardPile/IntroCardPile.stories.tsx#NoAnimation"]={docgenInfo:NoAnimation.__docgenInfo,name:"NoAnimation",path:"src/components/landing/IntroCardPile/IntroCardPile.stories.tsx#NoAnimation"})}catch(__react_docgen_typescript_loader_error){}}}]);
//# sourceMappingURL=components-landing-IntroCardPile-IntroCardPile-stories.4daa1070.iframe.bundle.js.map