...
`,Menu=props=>{const{children}=props;return(0,jsx_runtime.jsx)(MenuProvider,{children:(0,jsx_runtime.jsx)(Menu_styled_Wrapper,{children})})};Menu.displayName="Menu",Menu.Button=MenuButton_MenuButton,Menu.List=MenuList_MenuList,Menu.Item=MenuItem_MenuItem;const Menu_Menu=Menu;try{Menu.displayName="Menu",Menu.__docgenInfo={description:"",displayName:"Menu",props:{}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/common/Menu/Menu.tsx#Menu"]={docgenInfo:Menu.__docgenInfo,name:"Menu",path:"src/components/common/Menu/Menu.tsx#Menu"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/team/TeamColorEditModal/TeamColorEditModal.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>TeamColorEditModal_TeamColorEditModal});var useModal=__webpack_require__("./src/hooks/useModal.ts"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Backdrop=styled_components_browser_esm.I4.div`
  ...
  width: 100%;
  height: 100%;
`,BubbleContainer=styled_components_browser_esm.I4.div`
  position: fixed;
  ...
  box-shadow:
    ...
    0 5px 10px #1b1d1f1f;
`,Triangle=styled_components_browser_esm.I4.div`
  position: absolute;
...
`,InnerContainer=styled_components_browser_esm.I4.div`
  ...
  gap: 6px;
`,BadgeContainer=styled_components_browser_esm.I4.div`
  display: grid;
  grid-template-columns: repeat(5, 1fr);
  position: relative;
  justify-items: center;
  row-gap: 14px;
`,BadgeWrapper=styled_components_browser_esm.I4.div`
  display: flex;
...
`,Container=styled_components_browser_esm.I4.div`
  ...
  box-shadow:
    ...
    0 5px 10px #1b1d1f1f;
  background-color: ${({theme})=>theme.color.WHITE};
`,UserInfoForm=styled_components_browser_esm.I4.form`
  display: flex;
  align-items: center;
...
`,UserNameInputContainer=styled_components_browser_esm.I4.div`
  width: 200px;

  border: 1px solid ${({theme})=>theme.color.GRAY200};
  border-radius: 4px;
`,UserNameContainer=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  height: 20px;
  column-gap: 5px;
`,ProfileImage=styled_components_browser_esm.I4.img`
  width: 200px;
  height: 200px;
  margin: 10px auto;
  ...
  border-radius: 50%;
  object-fit: cover;
`,serviceCenterButton=styled_components_browser_esm.AH`
  display: flex;
  position: relative;
  align-self: flex-end;
  align-items: center;
  ...
  cursor: pointer;
`,logoutButton=(styled_components_browser_esm.AH`
  opacity: 0;
  color: ${({theme})=>theme.color.RED};
`,styled_components_browser_esm.AH`
  display: flex;
  ...
  padding: 8px;
  gap: 2px;
`),UserInfoModal_styled_userName=styled_components_browser_esm.AH`
  overflow: hidden;
  ...
  text-overflow: ellipsis;
  text-align: center;
`,UserInfoModal_styled_email=styled_components_browser_esm.AH`
  margin: 0 auto;

  font-size: 14px;
  color: ${({theme})=>theme.color.GRAY600};
`,userInfoEditButton=styled_components_browser_esm.AH`
  display: flex;
  align-items: center;
  justify-content: center;
...
`,userInfoSubmitButton=styled_components_browser_esm.AH`
  display: flex;
  align-items: center;
  justify-content: center;
...
`,userNameLength=styled_components_browser_esm.AH`
  font-size: 12px;
  color: ${({theme})=>theme.color.GRAY600};
  white-space: pre;
`,userNameInput=styled_components_browser_esm.AH`
  border: none;
  border-radius: 4px;
...
`,ButtonContainer=styled_components_browser_esm.I4.div`
  ...
  align-items: center;
  column-gap: 10px;
`,Divider=styled_components_browser_esm.I4.div`
  width: 1px;
  height: 24px;

  background-color: ${({theme})=>theme.color.GRAY500};
`,TeamBadgeEditIconWrapper=styled_components_browser_esm.I4.div`
  display: flex;
  justify-content: center;
  align-items: center;
...
`,TeamNameWrapper=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;
`,ProfileImage=styled_components_browser_esm.I4.img`
  ${({$isMobile})=>$isMobile?styled_components_browser_esm.AH`
  ...
  border-radius: 50%;
  object-fit: cover;
`,userInfoButton=(styled_components_browser_esm.AH`
  font-size: 24px;
  font-weight: bold;
`,styled_components_browser_esm.AH`
  display: flex;
...
`,$isMobile=>styled_components_browser_esm.AH`
  ...
  padding: 0;
`),teamColorButton=(modalOpenType,isModalOpen)=>styled_components_browser_esm.AH`
  display: flex;
  position: relative;
  justify-content: center;
  align-items: center;
...
`,explainText=styled_components_browser_esm.AH`
  font-size: 10px;
`;var TeamBadge=__webpack_require__("./src/components/team/TeamBadge/TeamBadge.tsx"),useTeamPlace=__webpack_require__("./src/hooks/useTeamPlace.ts"),TeamPlaceMenu=__webpack_require__("./src/components/team/TeamPlaceMenu/TeamPlaceMenu.tsx"),routes=__webpack_require__("./src/constants/routes.ts"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),constants_localStorage=__webpack_require__("./src/constants/localStorage.ts"),TeamPlaceInfoModal=__webpack_require__("./src/components/team/TeamPlaceInfoModal/TeamPlaceInfoModal.tsx"),useModal=__webpack_require__("./src/hooks/useModal.ts"),useFetchUserInfo=__webpack_require__("./src/hooks/queries/useFetchUserInfo.ts"),UserInfoModal=__webpack_require__("./src/components/user/UserInfoModal/UserInfoModal.tsx"),TeamColorEditModal=__webpack_require__("./src/components/team/TeamColorEditModal/TeamColorEditModal.tsx"),AccountDeleteModal=__webpack_require__("./src/components/user/AccountDeleteModal/AccountDeleteModal.tsx"),ServiceCenterModal=__webpack_require__("./src/components/user/ServiceCenterModal/ServiceCenterModal.tsx"),getIsMobile=__webpack_require__("./src/utils/getIsMobile.ts"),Text=__webpack_require__("./src/components/common/Text/Text.tsx"),team=__webpack_require__("./src/apis/team.ts"),query=__webpack_require__("./src/constants/query.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Header_stories={title:"common/Header",component:()=>{const{teamPlaces,teamPlaceId,changeTeamPlace,teamPlaceColor,displayName}=(0,useTeamPlace.Y)(),navigate=(0,dist.Zp)(),{openModal,isModalOpen}=(0,useModal.h)(),isMobile=(0,getIsMobile.N)(),queryClient=(0,QueryClientProvider.jE)(),{userInfo}=(0,useFetchUserInfo.z)(),[teamName,setTeamName]=(0,react.useState)(displayName??""),[modalOpenType,setModalOpenType]=(0,react.useState)(),prefetchTeamPlaceInfo=async()=>{teamPlaceId&&(await queryClient.prefetchQuery(["teamPlaceMembers",teamPlaceId],(()=>(0,team.ec)(teamPlaceId)),{staleTime:query.S.TEAM_PLACE_MEMBERS}),await queryClient.prefetchQuery(["teamPlaceInviteCode",teamPlaceId],(()=>(0,team.HT)(teamPlaceId)),{staleTime:query.S.TEAM_PLACE_INVITE_CODE}))},handleTeamNameChange=(0,react.useCallback)((value=>{if(""===value)return void setTeamName((()=>""));const newTeamPlace=teamPlaces.find((teamPlace=>teamPlace.displayName===value));void 0!==newTeamPlace&&(changeTeamPlace(newTeamPlace.id),setTeamName((()=>value)),location.pathname===routes.K.TEAM_SELECT&&navigate(isMobile?routes.K.TEAM_CALENDAR:routes.K.TEAM_OVERVIEW))}),[changeTeamPlace,teamPlaces]);return(0,react.useEffect)((()=>{const id=localStorage.getItem(constants_localStorage.C.TEAM_PLACE_ID);teamPlaceId===Number(id)&&handleTeamNameChange(displayName)}),[handleTeamNameChange,displayName,teamPlaceId]),(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[(0,jsx_runtime.jsxs)(Header,{tabIndex:0,$isMobile:isMobile,children:[(0,jsx_runtime.jsxs)(InnerContainer,{children:[!isMobile&&(0,jsx_runtime.jsx)(react_router_dom_dist.N_,{to:routes.K.TEAM_OVERVIEW,"aria-label":"모아보기 페이지로 가기",children:(0,jsx_runtime.jsx)(svg.f,{})}),(0,jsx_runtime.jsxs)("div",{children:[(0,jsx_runtime.jsxs)(Button.A,{type:"button",variant:"plain",onClick:()=>{setModalOpenType((()=>"teamColor")),openModal()},css:teamColorButton(modalOpenType,isModalOpen),"aria-label":"팀 색상 변경하기",children:[(0,jsx_runtime.jsx)(TeamBadge.A,{size:"lg",teamPlaceColor}),(0,jsx_runtime.jsx)(TeamBadgeEditIconWrapper,{children:(0,jsx_runtime.jsx)(svg.qU,{})})]}),(0,jsx_runtime.jsx)(TeamNameWrapper,{children:(0,jsx_runtime.jsx)(TeamPlaceMenu.A,{displayValue:teamName,onSelect:handleTeamNameChange})})]})]}),(0,jsx_runtime.jsxs)(ButtonContainer,{children:[(0,jsx_runtime.jsxs)(Button.A,{type:"button",variant:"plain",onFocus:prefetchTeamPlaceInfo,onMouseEnter:prefetchTeamPlaceInfo,onClick:()=>{setModalOpenType((()=>"team")),openModal()},css:($isMobile=isMobile,styled_components_browser_esm.AH`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`),"aria-label":"팀 정보 보기",children:[(0,jsx_runtime.jsx)(svg.Pv,{height:isMobile?"32":"22"}),!isMobile&&(0,jsx_runtime.jsx)(Text.A,{as:"span",css:explainText,children:"팀 정보"})]}),(0,jsx_runtime.jsx)(Divider,{}),(0,jsx_runtime.jsx)(Button.A,{type:"button",variant:"plain",css:userInfoButton(isMobile),onClick:()=>{setModalOpenType((()=>"user")),openModal()},"aria-label":"프로필 보기",children:(0,jsx_runtime.jsx)(ProfileImage,{$isMobile:isMobile,src:userInfo?.profileImageUrl,alt:"프로필 사진"})})]})]}),"team"===modalOpenType&&(0,jsx_runtime.jsx)(TeamPlaceInfoModal.A,{}),"user"===modalOpenType&&(0,jsx_runtime.jsx)(UserInfoModal.A,{onServiceCenterButtonClick:()=>{setModalOpenType((()=>"serviceCenter")),openModal()}}),"serviceCenter"===modalOpenType&&(0,jsx_runtime.jsx)(ServiceCenterModal.A,{onAccountDeleteButtonClick:()=>{setModalOpenType((()=>"accountDelete")),openModal()}}),"teamColor"===modalOpenType&&(0,jsx_runtime.jsx)(TeamColorEditModal.A,{}),"accountDelete"===modalOpenType&&(0,jsx_runtime.jsx)(AccountDeleteModal.A,{})]});var $isMobile},tags:["autodocs"]},Default={args:{}},__namedExportsOrder=["Default"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  args: {}\n}",...Default.parameters?.docs?.source}}}}}]);
//# sourceMappingURL=components-common-Header-Header-stories.cdff988a.iframe.bundle.js.map