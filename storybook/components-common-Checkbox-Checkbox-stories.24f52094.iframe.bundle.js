"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[4963],{"./src/components/common/Checkbox/Checkbox.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{CustomColor:()=>CustomColor,CustomStyle:()=>CustomStyle,ExtraLarge:()=>ExtraLarge,ExtraLargeNotChecked:()=>ExtraLargeNotChecked,Large:()=>Large,LargeNotChecked:()=>LargeNotChecked,Medium:()=>Medium,MediumNotChecked:()=>MediumNotChecked,Small:()=>Small,SmallNotChecked:()=>SmallNotChecked,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Checkbox_stories});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const checkboxSizes={sm:styled_components_browser_esm.AH`
    width: 20px;
    height: 20px;
    border-radius: 2px;
