...
`,styled_components_browser_esm.I4.div`
  ...
  animation-delay: ${({$delay})=>$delay};
`);var svg=__webpack_require__("./src/assets/svg/index.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const FileDriveDecoration_FileDriveDecoration=()=>(0,jsx_runtime.jsxs)(Container,{children:[(0,jsx_runtime.jsx)(SampleBadge,{}),(0,jsx_runtime.jsx)(svg.FolderOpenIcon,{}),(0,jsx_runtime.jsxs)(WritingLinesContainer,{children:[(0,jsx_runtime.jsx)(WritingLine,{$width:"46%",$delay:"0s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"60%",$delay:"0.3s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"52%",$delay:"0.6s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"0",$delay:"0"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"60%",$delay:"0.9s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"72%",$delay:"1.2s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"66%",$delay:"1.5s"}),(0,jsx_runtime.jsx)(WritingLine,{$width:"38%",$delay:"1.8s"})]})]})},"./src/components/landing/TeamCalendarDecoration/TeamCalendarDecoration.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>TeamCalendarDecoration_TeamCalendarDecoration});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.div`
  display: flex;
  flex-direction: column;
  row-gap: 30px;
