...
`,TableContainer=styled_components_browser_esm.zo.div`
  ...
  padding: ${({linkSize})=>"md"===linkSize?30:10}px;
...
`,linkTableTitle=linkSize=>styled_components_browser_esm.iv`
  font-size: ${"md"===linkSize?28:18}px;
