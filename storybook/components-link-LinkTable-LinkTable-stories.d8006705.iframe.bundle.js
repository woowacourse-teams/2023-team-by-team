"use strict";(self.webpackChunkfrontend=self.webpackChunkfrontend||[]).push([[1120],{"./src/components/link/LinkTable/LinkTable.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>LinkTable_stories});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.div`
  display: flex;
  ...
  width: 100%;
  height: 100%;
`,MenuHeader=styled_components_browser_esm.I4.header`
  display: flex;
...
`,Table=styled_components_browser_esm.I4.table`
  width: 100%;
...
`,linkTableTitle=linkSize=>styled_components_browser_esm.AH`
  font-size: ${"md"===linkSize?24:18}px;
`,linkAddButton=linkSize=>styled_components_browser_esm.AH`
  display: flex;
...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Text=props=>{const{as="p",size,weight,css,children}=props;return(0,jsx_runtime.jsx)(TextWrapper,{as,size,css,weight,children})},Text_Text=Text;try{Text.displayName="Text",Text.__docgenInfo={description:"",displayName:"Text",props:{as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"h1"'},{value:'"h2"'},{value:'"h3"'},{value:'"h4"'},{value:'"h5"'},{value:'"h6"'},{value:'"p"'},{value:'"span"'},{value:'"strong"'}]}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"xxs"'},{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"xl"'},{value:'"xxl"'}]}},weight:{defaultValue:null,description:"",name:"weight",required:!1,type:{name:"enum",value:[{value:'"bold"'},{value:'"normal"'},{value:'"light"'},{value:'"semiBold"'}]}},css:{defaultValue:null,description:"",name:"css",required:!1,type:{name:"CSSProp"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/common/Text/Text.tsx#Text"]={docgenInfo:Text.__docgenInfo,name:"Text",path:"src/components/common/Text/Text.tsx#Text"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/link/EmptyLinkPlaceholder/EmptyLinkPlaceholder.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>EmptyLinkPlaceholder_EmptyLinkPlaceholder});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.div`
  ...
  width: 100%;
  height: 100%;
`,PlaceholderContainer=styled_components_browser_esm.I4.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  row-gap: 18px;
  ...
  width: 100%;
  height: 100%;
`,LinkEmptyImage=styled_components_browser_esm.I4.img`
  width: 18%;
  margin-bottom: 10px;
`,placeholderButton=styled_components_browser_esm.AH`
  width: 380px;
  height: 220px;
  padding: 0;
`,titleText=styled_components_browser_esm.AH`
  font-size: 28px;
  color: ${({theme})=>theme.color.GRAY400};
`,clickToAddText=styled_components_browser_esm.AH`
  font-size: 20px;
  color: ${({theme})=>theme.color.GRAY500};
`;var Button=__webpack_require__("./src/components/common/Button/Button.tsx"),Text=__webpack_require__("./src/components/common/Text/Text.tsx"),png=__webpack_require__("./src/assets/png/index.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const EmptyLinkPlaceholder=props=>{const{onClick}=props;return(0,jsx_runtime.jsx)(Container,{children:(0,jsx_runtime.jsx)(Button.A,{variant:"plain",onClick,css:placeholderButton,"aria-label":"새로운 링크 등록하기",children:(0,jsx_runtime.jsxs)(PlaceholderContainer,{children:[(0,jsx_runtime.jsx)(LinkEmptyImage,{src:png.H_,alt:"비어있는 링크 이미지"}),(0,jsx_runtime.jsx)(Text.A,{weight:"bold",css:titleText,children:"등록된 링크가 없어요"}),(0,jsx_runtime.jsx)(Text.A,{weight:"semiBold",css:clickToAddText,children:"여기를 클릭해 새로운 링크를 등록해보세요"})]})})})},EmptyLinkPlaceholder_EmptyLinkPlaceholder=EmptyLinkPlaceholder;try{EmptyLinkPlaceholder.displayName="EmptyLinkPlaceholder",EmptyLinkPlaceholder.__docgenInfo={description:"",displayName:"EmptyLinkPlaceholder",props:{onClick:{defaultValue:null,description:"",name:"onClick",required:!0,type:{name:"() => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/link/EmptyLinkPlaceholder/EmptyLinkPlaceholder.tsx#EmptyLinkPlaceholder"]={docgenInfo:EmptyLinkPlaceholder.__docgenInfo,name:"EmptyLinkPlaceholder",path:"src/components/link/EmptyLinkPlaceholder/EmptyLinkPlaceholder.tsx#EmptyLinkPlaceholder"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/link/LinkAddModal/LinkAddModal.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>LinkAddModal_LinkAddModal});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Backdrop=styled_components_browser_esm.I4.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,Container=styled_components_browser_esm.I4.div`
  ...
  display: flex;
  flex-direction: column;
  ${({$linkSize})=>"md"===$linkSize?styled_components_browser_esm.AH`
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
      `:"sm"===$linkSize?styled_components_browser_esm.AH`
        top: 96%;
        left: 14%;
...
`,InputContainer=styled_components_browser_esm.I4.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
...
`,title=styled_components_browser_esm.AH`
  ...
  font-size: 18px;
`;var Modal=__webpack_require__("./src/components/common/Modal/Modal.tsx"),Button=__webpack_require__("./src/components/common/Button/Button.tsx"),svg=__webpack_require__("./src/assets/svg/index.ts"),Text=__webpack_require__("./src/components/common/Text/Text.tsx"),Input=__webpack_require__("./src/components/common/Input/Input.tsx"),react=__webpack_require__("./node_modules/react/index.js"),QueryClientProvider=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/QueryClientProvider.mjs"),useMutation=__webpack_require__("./node_modules/@tanstack/react-query/build/lib/useMutation.mjs"),apis_link=__webpack_require__("./src/apis/link.ts");var useModal=__webpack_require__("./src/hooks/useModal.ts"),useTeamPlace=__webpack_require__("./src/hooks/useTeamPlace.ts"),useToast=__webpack_require__("./src/hooks/useToast.ts"),generateHttpsUrl=__webpack_require__("./src/utils/generateHttpsUrl.ts"),constants_link=__webpack_require__("./src/constants/link.ts");const useTeamLinkAddModal=linkRef=>{const{teamPlaceId}=(0,useTeamPlace.Y)(),{closeModal}=(0,useModal.h)(),[linkName,setLinkName]=(0,react.useState)(""),[link,setLink]=(0,react.useState)(""),{showToast}=(0,useToast.d)(),{mutateSendTeamLink}=(teamPlaceId=>{const queryClient=(0,QueryClientProvider.jE)(),{mutate}=(0,useMutation.n)((body=>(0,apis_link.qB)(teamPlaceId,body)),{onSuccess:()=>{queryClient.invalidateQueries(["teamLinks",teamPlaceId])}});return{mutateSendTeamLink:mutate}})(teamPlaceId),handleClose=()=>{setLinkName((()=>"")),setLink((()=>"")),closeModal()};return{linkName,link,handlers:{handleClose,handleTeamLinkSubmit:e=>{if(e.preventDefault(),!constants_link._.test(link))return showToast("error","올바르지 않은 링크 형식입니다."),void linkRef.current?.focus();mutateSendTeamLink({title:linkName,url:(0,generateHttpsUrl.m)(link)},{onSuccess:()=>{showToast("success","링크가 등록되었습니다."),handleClose()}})},handleLinkNameChange:e=>{const{value}=e.target;setLinkName((()=>value))},handleLinkChange:e=>{const{value}=e.target;setLink((()=>value))}}}};var getIsMobile=__webpack_require__("./src/utils/getIsMobile.ts"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const LinkAddModal=props=>{const{linkSize="md"}=props,isMobile=(0,getIsMobile.N)(),linkRef=(0,react.useRef)(null),{linkName,link,handlers:{handleClose,handleTeamLinkSubmit,handleLinkNameChange,handleLinkChange}}=useTeamLinkAddModal(linkRef);return(0,jsx_runtime.jsxs)(Modal.A,{children:[(0,jsx_runtime.jsx)(Backdrop,{onClick:handleClose}),(0,jsx_runtime.jsxs)(Container,{$linkSize:linkSize,$isMobile:isMobile,children:[(0,jsx_runtime.jsx)(IconWrapper,{children:(0,jsx_runtime.jsx)(Button.A,{variant:"plain",type:"button",onClick:handleClose,css:closeButton,"aria-label":"팀 링크 등록 모달 닫기",children:(0,jsx_runtime.jsx)(svg.CloseIcon,{})})}),(0,jsx_runtime.jsxs)("form",{onSubmit:handleTeamLinkSubmit,children:[(0,jsx_runtime.jsxs)(InputContainer,{children:[(0,jsx_runtime.jsx)(Text.A,{size:"lg",weight:"semiBold",children:"링크 이름"}),(0,jsx_runtime.jsx)(Input.A,{width:"100%",height:"38px",placeholder:"링크 이름을 입력해 주세요.",css:title,value:linkName,onChange:handleLinkNameChange,required:!0})]}),(0,jsx_runtime.jsxs)(InputContainer,{children:[(0,jsx_runtime.jsx)(Text.A,{size:"lg",weight:"semiBold",children:"링크"}),(0,jsx_runtime.jsx)(Input.A,{width:"100%",height:"38px",placeholder:"공유할 링크를 입력해 주세요.",css:title,value:link,ref:linkRef,onChange:handleLinkChange,required:!0})]}),(0,jsx_runtime.jsx)(ControlButtonWrapper,{children:(0,jsx_runtime.jsx)(Button.A,{variant:"primary",css:submitButton,children:"등록"})})]})]})]})},LinkAddModal_LinkAddModal=LinkAddModal;try{LinkAddModal.displayName="LinkAddModal",LinkAddModal.__docgenInfo={description:"",displayName:"LinkAddModal",props:{linkSize:{defaultValue:null,description:"",name:"linkSize",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'}]}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/link/LinkAddModal/LinkAddModal.tsx#LinkAddModal"]={docgenInfo:LinkAddModal.__docgenInfo,name:"LinkAddModal",path:"src/components/link/LinkAddModal/LinkAddModal.tsx#LinkAddModal"})}catch(__react_docgen_typescript_loader_error){}},"./src/constants/link.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{K:()=>linkTableHeaderValues,_:()=>URL_REGEX});const linkTableHeaderValues=["링크명","이름","날짜",""],URL_REGEX=/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([-.]{1}[a-z0-9]+)*\.[a-z]{2,12}(:[0-9]{1,5})?(\/.*)?$/i},"./src/constants/query.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{S:()=>STALE_TIME});const STALE_TIME={SCHEDULES:3e4,DAILY_SCHEDULES:3e4,MY_SCHEDULES:3e4,MY_DAILY_SCHEDULES:3e4,USER_INFO:3e5,TEAM_PLACE_MEMBERS:6e4,TEAM_PLACE_INVITE_CODE:1/0,TEAM_LINKS:6e4,TEAM_FEED:3e5,ICALENDAR_URL:1/0}},"./src/hooks/useModal.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{h:()=>useModal});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_components_common_Modal_ModalContext__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/common/Modal/ModalContext.tsx");const useModal=()=>{const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_components_common_Modal_ModalContext__WEBPACK_IMPORTED_MODULE_1__.V);if(void 0===context)throw new Error("useModal must be used within a ModalProvider");return context}},"./src/hooks/useTeamPlace.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{Y:()=>useTeamPlace});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_contexts_TeamPlaceContext__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/contexts/TeamPlaceContext.tsx");const useTeamPlace=()=>{const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_contexts_TeamPlaceContext__WEBPACK_IMPORTED_MODULE_1__.W);if(void 0===context)throw new Error("useTeamPlace must be used within a TeamPlaceContext");return context}},"./src/hooks/useToast.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{d:()=>useToast});var react__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/react/index.js"),_components_common_Toast_ToastContext__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./src/components/common/Toast/ToastContext.tsx");const useToast=()=>{const context=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_components_common_Toast_ToastContext__WEBPACK_IMPORTED_MODULE_1__.$);if(void 0===context)throw new Error("useToast must be used within a ToastProvider");return context}},"./src/utils/generateHttpsUrl.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{m:()=>generateHttpsUrl});const HTTPS_PREFIX_REGEX=/^https?:\/\/.*/,generateHttpsUrl=url=>HTTPS_PREFIX_REGEX.test(url)?url:`https://${url}`},"./src/utils/getIsMobile.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{N:()=>getIsMobile});const getIsMobile=()=>{const isIos=null!==window.navigator.userAgent.match(/ipad|iphone/i),isAndroid=null!==window.navigator.userAgent.match(/Android/i);return!(!isIos&&!isAndroid)}}}]);
//# sourceMappingURL=components-link-LinkTable-LinkTable-stories.d8006705.iframe.bundle.js.map