...
`;var jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const ImageAddButton=props=>{const{onChangeImage}=props;return(0,jsx_runtime.jsxs)("label",{children:[(0,jsx_runtime.jsx)(FakeButton,{role:"button","aria-label":"이미지 추가",children:(0,jsx_runtime.jsx)(svg.PlusIcon,{})}),(0,jsx_runtime.jsx)(FileUploadInput,{type:"file",accept:"image/*",onChange:onChangeImage,multiple:!0})]})},ImageAddButton_ImageAddButton=ImageAddButton;try{ImageAddButton.displayName="ImageAddButton",ImageAddButton.__docgenInfo={description:"",displayName:"ImageAddButton",props:{onChangeImage:{defaultValue:null,description:"",name:"onChangeImage",required:!0,type:{name:"(e: ChangeEvent<HTMLInputElement>) => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/feed/ImageAddButton/ImageAddButton.tsx#ImageAddButton"]={docgenInfo:ImageAddButton.__docgenInfo,name:"ImageAddButton",path:"src/components/feed/ImageAddButton/ImageAddButton.tsx#ImageAddButton"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/feed/Thread/Thread.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>Thread_Thread});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.div`
  ...
  z-index: 0;
`,BodyContainer=styled_components_browser_esm.I4.div`
  display: flex;
...
`,ContentContainer=styled_components_browser_esm.I4.div`
  ...
  ${({$isMe,theme})=>$isMe?styled_components_browser_esm.AH`
  ...
  transition: 0.3s;
`,ContentWrapper=styled_components_browser_esm.I4.div`
  position: relative;
  overflow: hidden;

  padding: 10px 24px;
`,ThreadHeader=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;
  column-gap: 8px;

  height: 36px;
`,Author=styled_components_browser_esm.I4.div`
  display: flex;
  align-items: center;
  gap: 10px;
`,ProfileImg=styled_components_browser_esm.I4.img`
  width: 30px;
  height: 30px;
  ...
  object-fit: cover;
`,ThumbnailListWrapper=styled_components_browser_esm.I4.div`
  width: 100%;
  height: 136px;
...
`,threadInfoText=styled_components_browser_esm.AH`
  white-space: pre-wrap;

  font-size: 14px;
  color: ${({theme})=>theme.color.BLACK};
`,contentField=(threadSize,isMe)=>styled_components_browser_esm.AH`
  width: 100%;
  white-space: pre-wrap;
...
`;var Text=__webpack_require__("./src/components/common/Text/Text.tsx"),parseThreadContent=__webpack_require__("./src/utils/parseThreadContent.ts"),react=__webpack_require__("./node_modules/react/index.js"),feed=__webpack_require__("./src/constants/feed.ts");var ThreadExpandButton=__webpack_require__("./src/components/feed/ThreadExpandButton/ThreadExpandButton.tsx"),ThumbnailList=__webpack_require__("./src/components/feed/ThumbnailList/ThumbnailList.tsx"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Thread=props=>{const{threadSize="md",authorName,profileImageUrl,isMe=!1,createdAt,content,images,isContinue,onClickImage}=props,createdTime=createdAt.split(" ")[1],parsedThreadContent=(0,parseThreadContent.V)(content),threadRef=(0,react.useRef)(null),contentRef=(0,react.useRef)(null),{shouldShowExpandButton,isExpanded,toggleExpanded,resultHeight}=((threadRef,contentRef)=>{const[threadHeight,setThreadHeight]=(0,react.useState)(0),[contentHeight,setContentHeight]=(0,react.useState)(0),[isExpanded,setExpanded]=(0,react.useState)(!1);return(0,react.useEffect)((()=>{if(!threadRef.current||!contentRef.current)return;const resizeObserver=new ResizeObserver((()=>{setThreadHeight((()=>threadRef.current?threadRef.current.clientHeight:0)),setContentHeight((()=>contentRef.current?contentRef.current.clientHeight:0))}));return resizeObserver.observe(threadRef.current),resizeObserver.observe(contentRef.current),()=>resizeObserver.disconnect()}),[contentRef,threadRef]),{shouldShowExpandButton:threadHeight>=feed.GB,isExpanded,toggleExpanded:()=>{setExpanded((prev=>!prev))},resultHeight:isExpanded?contentHeight+250:feed.GB}})(threadRef,contentRef);return(0,jsx_runtime.jsxs)(Container,{$isMe:isMe,children:[!isMe&&!isContinue&&(0,jsx_runtime.jsx)(ThreadHeader,{children:(0,jsx_runtime.jsxs)(Author,{children:[(0,jsx_runtime.jsx)(ProfileImg,{src:profileImageUrl,alt:authorName}),(0,jsx_runtime.jsx)(Text.A,{weight:"semiBold",css:threadInfoText,children:authorName})]})}),(0,jsx_runtime.jsxs)(BodyContainer,{$isMe:isMe,children:[(0,jsx_runtime.jsxs)(ContentContainer,{$isMe:isMe,ref:threadRef,$height:resultHeight,children:[(0,jsx_runtime.jsx)(ContentWrapper,{children:(0,jsx_runtime.jsx)("div",{ref:contentRef,children:(0,jsx_runtime.jsx)(Text.A,{css:contentField(threadSize,isMe),children:parsedThreadContent.map(((content,index)=>"text"===content.type?content.text:(0,jsx_runtime.jsx)(LinkContent,{target:"__blank",href:content.link,$isMe:isMe,children:content.text},index)))})})}),images.length>0&&(0,jsx_runtime.jsx)(ThumbnailListWrapper,{$isMe:isMe,$marginBottom:!shouldShowExpandButton,children:(0,jsx_runtime.jsx)(ThumbnailList.A,{mode:"view",images,onClick:onClickImage})}),shouldShowExpandButton&&(0,jsx_runtime.jsx)(ThreadExpandButton.A,{isExpanded,isMe,size:threadSize,onClick:toggleExpanded})]}),(0,jsx_runtime.jsx)("time",{children:(0,jsx_runtime.jsx)(Text.A,{css:threadInfoText,children:createdTime})})]})]})},Thread_Thread=Thread;try{Thread.displayName="Thread",Thread.__docgenInfo={description:"",displayName:"Thread",props:{threadSize:{defaultValue:null,description:"",name:"threadSize",required:!1,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'}]}},authorName:{defaultValue:null,description:"",name:"authorName",required:!0,type:{name:"string"}},profileImageUrl:{defaultValue:null,description:"",name:"profileImageUrl",required:!0,type:{name:"string"}},isMe:{defaultValue:null,description:"",name:"isMe",required:!1,type:{name:"boolean"}},createdAt:{defaultValue:null,description:"",name:"createdAt",required:!0,type:{name:"`${string}-${string}-${string} ${string}:${string}`"}},content:{defaultValue:null,description:"",name:"content",required:!0,type:{name:"string"}},images:{defaultValue:null,description:"",name:"images",required:!0,type:{name:"ThreadImage[]"}},isContinue:{defaultValue:null,description:"",name:"isContinue",required:!0,type:{name:"boolean"}},onClickImage:{defaultValue:null,description:"",name:"onClickImage",required:!0,type:{name:"(images: ThreadImage[], selectedImage: number) => void"}}}},"undefined"!=typeof STORYBOOK_REACT_CLASSES&&(STORYBOOK_REACT_CLASSES["src/components/feed/Thread/Thread.tsx#Thread"]={docgenInfo:Thread.__docgenInfo,name:"Thread",path:"src/components/feed/Thread/Thread.tsx#Thread"})}catch(__react_docgen_typescript_loader_error){}},"./src/components/feed/ThreadExpandButton/ThreadExpandButton.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>ThreadExpandButton_ThreadExpandButton});var styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js");const Container=styled_components_browser_esm.I4.div`
  ...
  width: 100%;
  height: 100%;
`,expandButton=(isMe,size)=>styled_components_browser_esm.AH`
  width: 100%;
  height: ${"md"===size?"80px":"70px"};
  padding: 30px 10px 10px 10px;
  margin-top: -30px;

  ${isMe?styled_components_browser_esm.AH`
